...
public class GRandomParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GRandomGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getConfigurationAccess().getGroup_3_1_5(), "rule__Configuration__Group_3_1_5__0");
			builder.put(grammarAccess.getConfigurationAccess().getGroup_3_1_6(), "rule__Configuration__Group_3_1_6__0");
			builder.put(grammarAccess.getConfigurationAccess().getGroup_3_1_9(), "rule__Configuration__Group_3_1_9__0");
			builder.put(grammarAccess.getConfigurationAccess().getGroup_3_1_10(), "rule__Configuration__Group_3_1_10__0");
			builder.put(grammarAccess.getConfigurationAccess().getGroup_3_1_11(), "rule__Configuration__Group_3_1_11__0");
			...
			builder.put(grammarAccess.getConfigurationAccess().getBNAssignment_3_1_5_0(), "rule__Configuration__BNAssignment_3_1_5_0");
			builder.put(grammarAccess.getConfigurationAccess().getBigNodesAssignment_3_1_5_2(), "rule__Configuration__BigNodesAssignment_3_1_5_2");
			builder.put(grammarAccess.getConfigurationAccess().getBNSAssignment_3_1_6_0(), "rule__Configuration__BNSAssignment_3_1_6_0");
			builder.put(grammarAccess.getConfigurationAccess().getBigNodeSizeAssignment_3_1_6_2(), "rule__Configuration__BigNodeSizeAssignment_3_1_6_2");
			builder.put(grammarAccess.getConfigurationAccess().getPrioAssignment_3_1_7(), "rule__Configuration__PrioAssignment_3_1_7");
			builder.put(grammarAccess.getConfigurationAccess().getHierarchyAssignment_3_1_8(), "rule__Configuration__HierarchyAssignment_3_1_8");
			builder.put(grammarAccess.getConfigurationAccess().getSeedAssignment_3_1_9_2(), "rule__Configuration__SeedAssignment_3_1_9_2");
			builder.put(grammarAccess.getConfigurationAccess().getFormatAssignment_3_1_10_2(), "rule__Configuration__FormatAssignment_3_1_10_2");
			builder.put(grammarAccess.getConfigurationAccess().getFilenameAssignment_3_1_11_2(), "rule__Configuration__FilenameAssignment_3_1_11_2");
